...
= 1.6.2
- Fixed:   Duplicate panel issue on Gutenberg pages fixed to ensure panel only appears once.

= 1.6.1
- Updated: Main panels updates for compatibility with classic editor.

= 1.6.0
- New:     Upsell option added to panels.

= 1.5.3
- Fixed:   Improved accessibility for slider navigation.
- Fixed:   Pingback in header.php changed from bloginfo to get_bloginfo to ensure compatibility with PHP v8+.
...
- Fixed:   Skip link added to header.
...
= 1.2.2
- Updated: Styling for link underlines improved further.
...
= 1.1.1
- Updated: Function alante_thinkup_title_select_cpt() added remove "archive" text from custom post type archive pages.
